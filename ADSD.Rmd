...
## Mean correlation per group 200 ROIs global signal regression
```{r Mean correlation per group 200 ROIs global signal regression}
# Correlation R
FC200gs = list()
...
## Plot: FC 200 ROIs global signal regression
```{r Plot: FC 200 ROIs global signal regression, fig.height=15, fig.width=12}
limR = c(-1, 1)
